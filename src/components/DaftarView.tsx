...
export const DaftarView: React.FC<DaftarViewProps> = ({ onSubmit, onSelesai, loading }) => {
    ...
    <div className="space-y-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-red-600 hover:bg-red-700 active:scale-[0.98] text-white p-4 rounded-xl font-bold shadow-lg shadow-red-600/20 transition disabled:opacity-50 flex items-center justify-center space-x-2 cursor-pointer mt-4"
        >
          {loading && (
          ...
          <span>{loading ? 'Mengirim Data...' : 'Kirim Pendaftaran'}</span>
        </button>
      </form>
    </div>
  );
